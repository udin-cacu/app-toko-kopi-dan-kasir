   ...
   <div class="container">
     ...
     <div class="collapse navbar-collapse" id="ftco-nav">
       <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item cart"><a href="{{ route('shop.cart2') }}" class="nav-link"><span class="icon icon-shopping_cart"></span><span class="bag d-flex justify-content-center align-items-center"><small>{{ array_sum(array_column($cart,'qty')) }}</small></span></a></li>
      </ul>
    </div>
  </div>
</nav>
